/*
 * \brief  Driver base for TI Sitara AM335x
...
#ifndef _INCLUDE__SPEC__AM335X__DRIVERS__UART_BASE_H_
#define _INCLUDE__SPEC__AM335X__DRIVERS__UART_BASE_H_

/* Genode includes */
#include <util/mmio.h>

namespace Genode { class Am335x_uart_base; }


/**
 * Driver base for AM335x UART-module
 */
class Genode::Am335x_uart_base : Mmio
{
	int dummy;
	/**
	 * Control register 1
...
//	}
	...
	public:
		 ...
		 */
		explicit Am335x_uart_base(addr_t const base) : Mmio(base)
		{
...
#endif /* _INCLUDE__SPEC__AM335X__DRIVERS__UART_BASE_H_ */
