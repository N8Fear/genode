/*
 * \brief  TI CPSW/Davinci ethernet driver Linux emulation environment
...
#ifndef _SRC__DRIVERS__NIC__CPSW__LX_EMUL_H_
#define _SRC__DRIVERS__NIC__CPSW__LX_EMUL_H_
