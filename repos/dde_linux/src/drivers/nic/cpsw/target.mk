...
SRC_C          += $(notdir $(wildcard $(LX_CONTRIB_DIR)/drivers/net/ethernet/ti/*.c))
...
#
CC_OPT_cpsw_ptp  = -Wno-unused-but-set-variable -Wno-unused-variable \
                  -Wno-maybe-uninitialized -Wno-uninitialized
CC_OPT_cpsw_main = -Wno-unused-but-set-variable -Wno-unused-variable \
...
vpath %.c  $(LX_CONTRIB_DIR)/drivers/net/ethernet/ti
