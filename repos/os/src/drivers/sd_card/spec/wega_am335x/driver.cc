...
{
  // TODO: maybe need to enable stuff in CM_PER
...
// TODO: provide initialization for other MMCs provided by the MCU?
Driver::Driver(Env &env)
:
	Driver_base(env.ram()),
	Attached_mmio(env, Am335x::MMCHS_0_BASE, Am335x::MMCHS_0_SIZE), _env(env)
{
